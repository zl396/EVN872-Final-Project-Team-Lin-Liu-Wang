...
## Research Question 1
What would the trend of clean energy generation be until the commitment years for each of the 12 states? 
```{r Clean Forecast, echo=FALSE, fig.align='center', fig.width=14}
...
## Research Question 2
What would the trend of total energy generation be until the commitment years for each of the 12 states?
```{r All Forecast, echo=FALSE}
...
## Research Question 3
How does the clean energy generation growth compare to the total energy generation growth? (Does clean eenrgy generation meet total energy generation?)
```{r Result, echo=FALSE}
