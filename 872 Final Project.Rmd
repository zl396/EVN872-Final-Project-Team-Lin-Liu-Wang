...
The following line charts depicts the forecasted trend until each state's commitment year: 
...
## Question 3: How does the clean energy generation growth compare to the total energy generation growth? (Does clean eenrgy generation meet total energy generation?)
```{r Result, echo=FALSE}
